-- Mode names: n (normal), v (visual), i (insert), t (terminal)
...
M.general = {
  ...
  n = {
    ...
    -- Clear whole buffer
    ["<Leader>cl"] = { "<cmd> %d!<CR>", "Clear whole buffer" },

    -- this is mapping for latex
     ["<leader>ll"] = { "<cmd>VimtexCompile<CR>", "Compile LaTeX" },
    ["<leader>lv"] = { "<cmd>VimtexView<CR>", "View PDF" },
    ["<leader>lk"] = { "<cmd>VimtexStop<CR>", "Stop LaTeX Compiler" },
    ["<leader>lc"] = { "<cmd>VimtexClean<CR>", "Clean Aux Files" },

    -- Save in normal mode 
     ["<C-s>"] = { "<cmd> w <CR>", "Save file" },
    
    -- here is autocompile command for different languages 
     ["<leader>co"] = { 
    function() 
      require("custom.autocompile").compile_file() 
    end, 
    "Compile current file" 
  },
    -- to select whole buffer 
    ["<C-a>"]={"ggVG", "selct whole buffer"},
    ...
    ["<leader>sx"] = { "<cmd> q <CR>", "Close split" },
  },
...
M.comment = {
  ...
  n = {
    ["<leader>rc"] = {
      function()
        require("core.remove_comment").remove_comments()
      end,
